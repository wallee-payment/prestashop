...
class WalleeModelCompletionjob extends ObjectModel
{
    ...
    public static function isCompletionRunningForTransaction($spaceId, $transactionId)
    {
        $result = DB::getInstance()->getValue(
            'SELECT id_completion_job FROM ' . _DB_PREFIX_ . 'wle_completion_job WHERE space_id = "' . (int) $spaceId .
